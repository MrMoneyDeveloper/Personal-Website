// Basic Three.js setup for the skills page model
// Loads a spell book model (SkillBook.glb) and rotates it

window.addEventListener('DOMContentLoaded', () => {
  const container = document.getElementById('skills-model');
